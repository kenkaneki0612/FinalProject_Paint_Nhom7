...
public class Frame extends JFrame {
	...
	public Frame() {
		...
		Image image = toolkit.getImage(Frame.class.getResource("/icons/cursor.png"));
		Image image1 = toolkit.getImage(Frame.class.getResource("/icons/hand.png"));
		...
		mainPanel.add(buttonsPanelForDrawing, BorderLayout.NORTH);
		mainPanel.add(view, BorderLayout.CENTER);
		buttonsGroup = new ButtonGroup();

		tglBtnDrawPoint = new JToggleButton(new ImageIcon(Frame.class.getResource("/icons/point.png")));
		...
		tglBtnDrawSquare = new JToggleButton(new ImageIcon(Frame.class.getResource("/icons/square.png")));
		...
		tglBtnDrawRectangle = new JToggleButton(new ImageIcon(Frame.class.getResource("/icons/rectangle.png")));
		...
		tglBtnDrawLine = new JToggleButton(new ImageIcon(Frame.class.getResource("/icons/line.png")));
		...
		tglBtnDrawCircle = new JToggleButton(new ImageIcon(Frame.class.getResource("/icons/circle.png")));
		...
		btnSaveDraw = new JButton(new ImageIcon(Frame.class.getResource("/icons/save.png")));
		...
		btnNewDraw = new JButton(new ImageIcon(Frame.class.getResource("/icons/new.png")));
		btnNewDraw.setText("New");
		...
		JButton btnOpenDraw = new JButton(new ImageIcon(Frame.class.getResource("/icons/open.png")));
		...
		btnLog = new JButton(new ImageIcon(Frame.class.getResource("/icons/log.png")));
		...
		tglBtnSelect = new JToggleButton(new ImageIcon(Frame.class.getResource("/icons/select.png")));
		...
		btnUpdate = new JButton(new ImageIcon(Frame.class.getResource("/icons/update.png")));
		...
		btnDelete = new JButton(new ImageIcon(Frame.class.getResource("/icons/delete.png")));
		...
		btnEdgeColor = new JButton(new ImageIcon(Frame.class.getResource("/icons/picker.png")));
		...
		btnInteriorColor = new JButton(new ImageIcon(Frame.class.getResource("/icons/color-picker.png")));
		...
		btnUndo = new JButton(new ImageIcon(Frame.class.getResource("/icons/undo.png")));
		...
		btnRedo = new JButton(new ImageIcon(Frame.class.getResource("/icons/redo.png")));
		...
		btnToFront = new JButton(new ImageIcon(Frame.class.getResource("/icons/to-front.png")));
		btnToFront.setText("");
		...
		btnToBack = new JButton(new ImageIcon(Frame.class.getResource("/icons/to-back.png")));
		btnToBack.setText("");
		...
		mouseAdapterLog = new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent click) {
				if (btnLog.getText().equals("Log")) {
					...
					btnLog.setText("Draw");
					btnLog.setIcon(new ImageIcon(Frame.class.getResource("/icons/draw.png")));
					
				} else if (btnLog.getText().equals("Draw")) {
					mainPanel.remove(scrollPane);
					mainPanel.add(view, BorderLayout.CENTER);
					btnLog.setText("Log");
					btnLog.setIcon(new ImageIcon(Frame.class.getResource("/icons/log.png")));
				}
