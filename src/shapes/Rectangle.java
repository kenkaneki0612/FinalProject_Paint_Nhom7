...
public class Rectangle extends Square {
    ...
    public boolean containsClick(int xCoordinate, int yCoordinate) {
        if (upLeft.getXcoordinate() <= xCoordinate && xCoordinate <= (upLeft.getXcoordinate() + width) 
        		&& upLeft.getYcoordinate() <= yCoordinate && yCoordinate <= upLeft.getYcoordinate() + side) return true;
        return false;
    }
