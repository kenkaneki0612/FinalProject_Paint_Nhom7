...
//Line input table creation class, adding or update Line
public class dialogLine extends JDialog {
	...
	public dialogLine() {
		...
		{
			lblxCoordinateInitial = new JLabel("X coordinate point");
		...
		{
			lblyCoordinateInitial = new JLabel("Y coordinate point");
		...
		{
			lblxCoordinateLast = new JLabel("X coordinate last point");
		...
		{
			lblyCoordinateLast = new JLabel("Y coordinate last point");
