...
//Class represent for parsing log command in interaction with user.
public class dialogLogParser extends JDialog {
	...
	public static void main(String[] args) {
		try {
			dialogLogParser dialog = new dialogLogParser();
